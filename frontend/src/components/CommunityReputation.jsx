  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      {stats.map((stat, index) => (
        <Card
          key={index}
          className="p-4 bg-gradient-to-br from-white to-indigo-50/30 shadow-md border border-indigo-100"
        >
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Powered by community reports, our reputation system helps identify
            and track online threats. One tap to report, collective intelligence
            to protect everyone.
          </p>
        </div>
          ...
          <TabsContent value="search" className="space-y-8">
            <Card className="p-6 bg-white shadow-lg border border-gray-200">
              ...
              <div className="flex gap-3">
                ...
                />
                <Button className="px-8">🔍 Check</Button>
              </div>
              <p className="text-sm text-gray-500 mt-2">
                Search our database of community-reported threats and reputation
                scores.
              </p>
            </Card>
