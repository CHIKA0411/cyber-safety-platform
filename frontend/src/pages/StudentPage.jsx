  ...
  const questions = [
    {
      ...
      options: [
        {
          text: "support@netflix.com - Your account will be suspended",
          correct: false,
        },
        {
          text: "noreply@netfl1x-security.com - Verify your account now!",
          correct: true,
        },
        {
          text: "billing@netflix.com - Payment receipt for your subscription",
          correct: false,
        },
      ],
      explanation:
        "The second email has a suspicious domain (netfl1x instead of netflix) and uses urgency tactics typical of phishing.",
    },
    {
      id: 2,
      ...
      options: [
        {
          text: "Software Engineer at Google - Apply through careers.google.com",
          correct: false,
        },
        {
          text: "Data Entry - Earn ₹5000/day working from home - No experience needed!",
          correct: true,
        },
        {
          text: "Marketing Intern at local startup - Unpaid but good experience",
          correct: false,
        },
      ],
      explanation:
        "Unrealistic pay for simple work and 'no experience needed' for high-paying jobs are red flags.",
    },
    {
      id: 3,
      ...
      explanation:
        "Official bank websites use HTTPS and the exact bank name. Avoid sites with extra words or HTTP.",
    },
  ];
          ...
          <TabsContent value="leaderboard" className="space-y-8">
            <Card className="p-8 text-center bg-gradient-to-br from-white to-indigo-50/50 shadow-xl border border-indigo-100">
              ...
              <p className="text-gray-600 mb-6">
                Compete with fellow students, earn badges, and climb the
                cybersecurity champion ranks!
              </p>
